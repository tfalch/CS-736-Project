...
enum zone_stat_item {
	...
	NR_ACTIVE_ANON,		/*  "     "     "   "       "         */
	NR_INACTIVE_LINKED_ANON,
	NR_ACTIVE_LINKED_ANON,
	NR_INACTIVE_FILE,	/*  "     "     "   "       "         */
	NR_ACTIVE_FILE,		/*  "     "     "   "       "         */
	NR_INACTIVE_LINKED_FILE,
	NR_ACTIVE_LINKED_FILE,
	NR_UNEVICTABLE,		/*  "     "     "   "       "         */
...
{
  return (l >= LRU_INACTIVE_FILE && l <= LRU_ACTIVE_LINKED_FILE);
}
...
static inline int is_linked_lru(enum lru_list l) 
{
  return (l == LRU_INACTIVE_LINKED_ANON || l == LRU_ACTIVE_LINKED_ANON ||
	  l == LRU_INACTIVE_LINKED_FILE || l == LRU_ACTIVE_LINKED_FILE);
}
